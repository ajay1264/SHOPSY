      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
          ...
          <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
              ...
              <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2'>
                  <img src={activeImage} className='h-full w-full object-scale-down mix-blend-multiply' onMouseMove={handleZoomImage} onMouseLeave={handleLeaveImageZoom} alt='img'/>
                          ...
                          data?.productImage?.map((imgURL,index) =>{
                            return(
                              <div className='h-20 w-20 bg-slate-200 rounded p-1' key={imgURL}>
                                <img src={imgURL} className='w-full h-full object-scale-down mix-blend-multiply cursor-pointer' onMouseEnter={()=>handleMouseEnterProduct(imgURL)}  onClick={()=>handleMouseEnterProduct(imgURL)} alt='img'/>
                              </div>
                            )
                          })
                        }
           ...
           {/***product details */}
           {
            loading ? (
              <div className='grid gap-1 w-full'>
                ...
                <h2 className='text-2xl lg:text-4xl font-medium h-6 lg:h-8  bg-slate-200 animate-pulse w-full'> {data?.productName || "Loading..."}</h2>
            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <h2 className='text-2xl lg:text-4xl font-medium'></h2>
